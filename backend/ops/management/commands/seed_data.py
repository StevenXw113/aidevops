...
def seed_marketplace_demo(stdout, hosts):
    ...
    deployments = [
        ...
        },
        {
            ...
            'deployer': 'admin',
            'deploy_dir': '/opt/aidevops/mongodb',
...
def seed_app_release_demo(stdout, hosts, docker_hosts):
    ...
    release_items = [
        ...
        },
        {
            ...
            'deploy_dir': '/opt/aidevops/apps/order-center-test',
        ...
        },
        {
            ...
            'deploy_dir': '/opt/aidevops/apps/order-center-prod',
        ...
        },
        {
            ...
            'deploy_dir': '/opt/aidevops/apps/member-center-prod',
