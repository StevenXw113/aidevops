PERMISSION_DEFINITIONS = [
    ...
    ('ops.iac.view', '查看 IaC 方案', 'ops', '查看 Terraform IaC 方案、渲染结果与执行记录'),
    ('ops.iac.manage', '管理 IaC 方案', 'ops', '创建、编辑、删除 Terraform IaC 方案并下载工程'),
    ('ops.iac.execute', '执行 IaC 方案', 'ops', '对 Terraform 方案执行 init/plan/apply/destroy 并同步 CMDB'),
    ('ops.multicloud.view', '查看多云资源', 'ops', '查看云账号、云环境与云资源清单'),
    ('ops.multicloud.manage', '管理多云账号', 'ops', '创建、编辑云账号并测试连接'),
    ('ops.multicloud.sync', '同步多云资源', 'ops', '执行云环境资源发现、批量同步与同步 CMDB'),
...
BUILTIN_ROLES = [
    ...
    },
    {
        ...
        'permissions': [
            ...
            'ops.iac.view', 'ops.iac.manage', 'ops.iac.execute',
