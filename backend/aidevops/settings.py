"""
Django settings for aidevops project.
...
def _resolve_config_file():
    raw_path = os.getenv('AIDEVOPS_CONFIG_FILE', 'config.json')
...
SYSTEM_POSTURE_ENABLED = _bool_value(
    _setting_value(
        ...
        ('AIDEVOPS_SYSTEM_POSTURE_ENABLED', 'SYSTEM_POSTURE_ENABLED'),
        False,
    ),
    False,
)
...
WSGI_APPLICATION = 'aidevops.wsgi.application'
...
# ASGI / Channels
ASGI_APPLICATION = 'aidevops.asgi.application'
